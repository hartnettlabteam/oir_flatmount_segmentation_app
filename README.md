...
1. Download `OIR-Flatmount-Segmentation-Windows-Setup.exe`. You can find this in the [releases section](https://github.com/hartnettlabteam/oir_flatmount_segmentation_app/releases)
